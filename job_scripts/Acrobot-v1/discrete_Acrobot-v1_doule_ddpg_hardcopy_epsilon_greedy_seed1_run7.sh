...
#SBATCH --output=/project/6001934/lingheng/Double_DDPG_Job_output/discrete_Acrobot-v1_doule_ddpg_hardcopy_epsilon_greedy_seed1_run7_%N-%j.out  # %N for node name, %j for jobID
