...
#SBATCH --output=/project/6001934/lingheng/Double_DDPG_Job_output/discrete_Acrobot-v1_ddpg_hardcopy_action_noise_seed4_run3_%N-%j.out  # %N for node name, %j for jobID
