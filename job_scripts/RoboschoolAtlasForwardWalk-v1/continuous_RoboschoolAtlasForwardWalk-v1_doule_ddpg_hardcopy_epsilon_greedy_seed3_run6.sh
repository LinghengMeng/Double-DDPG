...
#SBATCH --output=/project/6001934/lingheng/Double_DDPG_Job_output/continuous_RoboschoolAtlasForwardWalk-v1_doule_ddpg_hardcopy_epsilon_greedy_seed3_run6_%N-%j.out  # %N for node name, %j for jobID
