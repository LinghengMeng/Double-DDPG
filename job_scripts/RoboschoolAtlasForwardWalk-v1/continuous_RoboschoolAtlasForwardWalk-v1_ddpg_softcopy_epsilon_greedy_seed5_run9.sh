...
#SBATCH --output=../Double_DDPG_Job_output/continuous_RoboschoolAtlasForwardWalk-v1_ddpg_softcopy_epsilon_greedy_seed5_run9_%N-%j.out  # %N for node name, %j for jobID
