...
#SBATCH --output=../Double_DDPG_Job_output/continuous_BipedalWalkerHardcore-v2_doule_ddpg_softcopy_epsilon_greedy_seed4_run9_%N-%j.out  # %N for node name, %j for jobID
