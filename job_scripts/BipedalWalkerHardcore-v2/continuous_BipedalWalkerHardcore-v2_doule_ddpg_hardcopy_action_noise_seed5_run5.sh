...
#SBATCH --output=/project/6001934/lingheng/Double_DDPG_Job_output/continuous_BipedalWalkerHardcore-v2_doule_ddpg_hardcopy_action_noise_seed5_run5_%N-%j.out  # %N for node name, %j for jobID
