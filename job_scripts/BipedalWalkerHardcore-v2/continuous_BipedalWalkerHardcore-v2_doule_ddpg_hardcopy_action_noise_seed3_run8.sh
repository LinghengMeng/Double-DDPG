...
#SBATCH --output=../Double_DDPG_Job_output/continuous_BipedalWalkerHardcore-v2_doule_ddpg_hardcopy_action_noise_seed3_run8_%N-%j.out  # %N for node name, %j for jobID
