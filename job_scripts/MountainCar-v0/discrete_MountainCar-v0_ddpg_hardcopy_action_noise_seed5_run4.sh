...
#SBATCH --output=/project/6001934/lingheng/Double_DDPG_Job_output/discrete_MountainCar-v0_ddpg_hardcopy_action_noise_seed5_run4_%N-%j.out  # %N for node name, %j for jobID
