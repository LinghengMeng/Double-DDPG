...
#SBATCH --output=/project/6001934/lingheng/Double_DDPG_Job_output/discrete_MountainCar-v0_doule_ddpg_softcopy_epsilon_greedy_seed5_run0_%N-%j.out  # %N for node name, %j for jobID
