...
#SBATCH --output=/project/6001934/lingheng/Double_DDPG_Job_output/discrete_MountainCar-v0_ddpg_softcopy_epsilon_greedy_seed4_run3_%N-%j.out  # %N for node name, %j for jobID
