...
#SBATCH --output=/project/6001934/lingheng/Double_DDPG_Job_output/continuous_BipedalWalker-v2_doule_ddpg_hardcopy_epsilon_greedy_seed2_run5_%N-%j.out  # %N for node name, %j for jobID
