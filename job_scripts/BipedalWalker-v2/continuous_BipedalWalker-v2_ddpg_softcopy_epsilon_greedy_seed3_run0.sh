...
#SBATCH --output=/project/6001934/lingheng/Double_DDPG_Job_output/continuous_BipedalWalker-v2_ddpg_softcopy_epsilon_greedy_seed3_run0_%N-%j.out  # %N for node name, %j for jobID
