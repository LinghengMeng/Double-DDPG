...
#SBATCH --output=../Double_DDPG_Job_output/continuous_LunarLanderContinuous-v2_doule_ddpg_softcopy_epsilon_greedy_seed1_run6_%N-%j.out  # %N for node name, %j for jobID
