...
#SBATCH --output=/project/6001934/lingheng/Double_DDPG_Job_output/continuous_LunarLanderContinuous-v2_doule_ddpg_softcopy_action_noise_seed1_run6_%N-%j.out  # %N for node name, %j for jobID
