...
#SBATCH --output=../Double_DDPG_Job_output/continuous_RoboschoolInvertedPendulumSwingup-v1_doule_ddpg_softcopy_epsilon_greedy_seed3_run8_%N-%j.out  # %N for node name, %j for jobID
