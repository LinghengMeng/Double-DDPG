...
#SBATCH --output=../Double_DDPG_Job_output/continuous_RoboschoolInvertedPendulumSwingup-v1_ddpg_softcopy_epsilon_greedy_seed5_run3_%N-%j.out  # %N for node name, %j for jobID
