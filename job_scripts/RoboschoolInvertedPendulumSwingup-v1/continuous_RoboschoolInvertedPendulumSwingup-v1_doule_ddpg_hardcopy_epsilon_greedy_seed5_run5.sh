...
#SBATCH --output=../Double_DDPG_Job_output/continuous_RoboschoolInvertedPendulumSwingup-v1_doule_ddpg_hardcopy_epsilon_greedy_seed5_run5_%N-%j.out  # %N for node name, %j for jobID
