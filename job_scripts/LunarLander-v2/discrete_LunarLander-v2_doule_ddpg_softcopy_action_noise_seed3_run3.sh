...
#SBATCH --output=/project/6001934/lingheng/Double_DDPG_Job_output/discrete_LunarLander-v2_doule_ddpg_softcopy_action_noise_seed3_run3_%N-%j.out  # %N for node name, %j for jobID
