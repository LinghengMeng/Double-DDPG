...
#SBATCH --output=/project/6001934/lingheng/Double_DDPG_Job_output/discrete_LunarLander-v2_ddpg_hardcopy_epsilon_greedy_seed3_run9_%N-%j.out  # %N for node name, %j for jobID
