...
#SBATCH --output=/project/6001934/lingheng/Double_DDPG_Job_output/continuous_RoboschoolHumanoid-v1_ddpg_hardcopy_action_noise_seed1_run1_%N-%j.out  # %N for node name, %j for jobID
