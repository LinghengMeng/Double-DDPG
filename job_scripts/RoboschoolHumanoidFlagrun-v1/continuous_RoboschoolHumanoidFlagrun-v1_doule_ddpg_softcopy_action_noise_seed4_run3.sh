...
#SBATCH --output=../Double_DDPG_Job_output/continuous_RoboschoolHumanoidFlagrun-v1_doule_ddpg_softcopy_action_noise_seed4_run3_%N-%j.out  # %N for node name, %j for jobID
