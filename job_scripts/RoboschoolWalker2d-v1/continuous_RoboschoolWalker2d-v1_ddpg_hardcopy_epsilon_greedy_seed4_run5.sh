...
#SBATCH --output=/project/6001934/lingheng/Double_DDPG_Job_output/continuous_RoboschoolWalker2d-v1_ddpg_hardcopy_epsilon_greedy_seed4_run5_%N-%j.out  # %N for node name, %j for jobID
