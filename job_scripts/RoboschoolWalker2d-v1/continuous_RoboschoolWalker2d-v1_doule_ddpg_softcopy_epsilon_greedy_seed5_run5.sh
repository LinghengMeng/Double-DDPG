...
#SBATCH --output=../Double_DDPG_Job_output/continuous_RoboschoolWalker2d-v1_doule_ddpg_softcopy_epsilon_greedy_seed5_run5_%N-%j.out  # %N for node name, %j for jobID
