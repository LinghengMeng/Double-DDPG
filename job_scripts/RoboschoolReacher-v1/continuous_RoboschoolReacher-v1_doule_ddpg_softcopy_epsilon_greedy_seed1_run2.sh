...
#SBATCH --output=../Double_DDPG_Job_output/continuous_RoboschoolReacher-v1_doule_ddpg_softcopy_epsilon_greedy_seed1_run2_%N-%j.out  # %N for node name, %j for jobID
