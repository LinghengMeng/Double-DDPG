...
#SBATCH --output=/project/6001934/lingheng/Double_DDPG_Job_output/continuous_RoboschoolAnt-v1_ddpg_hardcopy_epsilon_greedy_seed3_run8_%N-%j.out  # %N for node name, %j for jobID
