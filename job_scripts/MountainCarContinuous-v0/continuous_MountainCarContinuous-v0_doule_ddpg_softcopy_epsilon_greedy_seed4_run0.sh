...
#SBATCH --output=../Double_DDPG_Job_output/continuous_MountainCarContinuous-v0_doule_ddpg_softcopy_epsilon_greedy_seed4_run0_%N-%j.out  # %N for node name, %j for jobID
