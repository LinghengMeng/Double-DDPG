...
#SBATCH --output=../Double_DDPG_Job_output/continuous_MountainCarContinuous-v0_doule_ddpg_hardcopy_action_noise_seed3_run0_%N-%j.out  # %N for node name, %j for jobID
