...
#SBATCH --output=../Double_DDPG_Job_output/continuous_RoboschoolHalfCheetah-v1_doule_ddpg_hardcopy_action_noise_seed2_run2_%N-%j.out  # %N for node name, %j for jobID
