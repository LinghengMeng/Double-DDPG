...
#SBATCH --output=/project/6001934/lingheng/Double_DDPG_Job_output/continuous_RoboschoolHalfCheetah-v1_doule_ddpg_softcopy_epsilon_greedy_seed2_run6_%N-%j.out  # %N for node name, %j for jobID
