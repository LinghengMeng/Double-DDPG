...
#SBATCH --output=../Double_DDPG_Job_output/continuous_RoboschoolHalfCheetah-v1_doule_ddpg_softcopy_action_noise_seed3_run6_%N-%j.out  # %N for node name, %j for jobID
