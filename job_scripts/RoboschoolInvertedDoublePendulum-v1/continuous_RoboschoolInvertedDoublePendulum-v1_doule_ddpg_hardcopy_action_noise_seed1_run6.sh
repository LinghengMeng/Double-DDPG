...
#SBATCH --output=../Double_DDPG_Job_output/continuous_RoboschoolInvertedDoublePendulum-v1_doule_ddpg_hardcopy_action_noise_seed1_run6_%N-%j.out  # %N for node name, %j for jobID
