...
#SBATCH --output=../Double_DDPG_Job_output/continuous_RoboschoolInvertedDoublePendulum-v1_ddpg_softcopy_epsilon_greedy_seed2_run7_%N-%j.out  # %N for node name, %j for jobID
