...
#SBATCH --output=../Double_DDPG_Job_output/continuous_RoboschoolInvertedDoublePendulum-v1_ddpg_hardcopy_action_noise_seed2_run6_%N-%j.out  # %N for node name, %j for jobID
