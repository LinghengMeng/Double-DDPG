...
#SBATCH --output=/project/6001934/lingheng/Double_DDPG_Job_output/discrete_CartPole-v1_doule_ddpg_softcopy_epsilon_greedy_seed3_run4_%N-%j.out  # %N for node name, %j for jobID
