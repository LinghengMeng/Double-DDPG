...
#SBATCH --output=/project/6001934/lingheng/Double_DDPG_Job_output/continuous_Pendulum-v0_doule_ddpg_hardcopy_action_noise_seed5_run7_%N-%j.out  # %N for node name, %j for jobID
