...
#SBATCH --output=/project/6001934/lingheng/Double_DDPG_Job_output/continuous_RoboschoolHumanoidFlagrunHarder-v1_ddpg_hardcopy_action_noise_seed2_run9_%N-%j.out  # %N for node name, %j for jobID
