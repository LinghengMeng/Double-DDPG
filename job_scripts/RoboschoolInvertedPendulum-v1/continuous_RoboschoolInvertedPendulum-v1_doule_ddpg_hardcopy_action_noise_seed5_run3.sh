...
#SBATCH --output=../Double_DDPG_Job_output/continuous_RoboschoolInvertedPendulum-v1_doule_ddpg_hardcopy_action_noise_seed5_run3_%N-%j.out  # %N for node name, %j for jobID
