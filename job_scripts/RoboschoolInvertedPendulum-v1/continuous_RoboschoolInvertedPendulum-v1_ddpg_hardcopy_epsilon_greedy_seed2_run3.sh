...
#SBATCH --output=../Double_DDPG_Job_output/continuous_RoboschoolInvertedPendulum-v1_ddpg_hardcopy_epsilon_greedy_seed2_run3_%N-%j.out  # %N for node name, %j for jobID
