...
#SBATCH --output=../Double_DDPG_Job_output/continuous_RoboschoolInvertedPendulum-v1_ddpg_softcopy_epsilon_greedy_seed5_run1_%N-%j.out  # %N for node name, %j for jobID
