...
#SBATCH --output=/project/6001934/lingheng/Double_DDPG_Job_output/continuous_RoboschoolInvertedPendulum-v1_doule_ddpg_softcopy_action_noise_seed5_run1_%N-%j.out  # %N for node name, %j for jobID
