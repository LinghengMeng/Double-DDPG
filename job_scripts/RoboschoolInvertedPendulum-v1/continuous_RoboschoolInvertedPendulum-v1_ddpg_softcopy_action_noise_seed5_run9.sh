...
#SBATCH --output=../Double_DDPG_Job_output/continuous_RoboschoolInvertedPendulum-v1_ddpg_softcopy_action_noise_seed5_run9_%N-%j.out  # %N for node name, %j for jobID
